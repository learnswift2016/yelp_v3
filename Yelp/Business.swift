...
class Business: NSObject {
    ...
    init(dictionary: NSDictionary) {
        ...
        self.latitude = coordinate.valueForKeyPath("latitude") as? Double
        self.longtitude = coordinate.valueForKeyPath("longitude") as? Double
        var address = ""
        if location != nil {
    ...
    class func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, radius: NSNumber, completion: ([Business]!, NSError!) -> Void) -> Void {
